...
| --- |  --- | ---
| [Interactive Voice Response Bot](https://github.com/BuckWoody/LearningPaths/blob/master/Developer/Learning%20Path%20-%20Interactive%20Voice%20Response%20Bot.md) | Solution | Automated customer interaction is essential to a business of any size. In an era when mobile phones are dominant and keypads are not always readily accessible, interactive voice response (IVR) systems provide an intuitive, simple, and convenient method for customers to convey their requests. This Learning Path teaches you how to implement an IVR system for multiple uses.
