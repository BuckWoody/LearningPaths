...
| --- | --- | --- | --- | --- 
|Be able to create effective bots with Microsoft Bot Framework | Applications for bots | This video about real world [scenarios for bots](https://channel9.msdn.com/Series/Explain/Bots-101-Scenarios-for-bots) | Bot Framework | Overview
| | How the Bot Framework works|This web page about [how the bot framework works](https://docs.microsoft.com/en-us/bot-framework/overview-how-bot-framework-works) | Bot Framework | Overview
...
| | Handing off a bot to a human|This article about creating [bot to human handover in Node.js](https://www.microsoft.com/reallifecode/2017/06/30/bot-to-human-handover-in-node-js/) | Bot Framework, Node.js, Application Insights | Advanced
...
|Be able to add complex language understanding to bots|What is LUIS|These videos containing an [overview of LUIS](https://www.youtube.com/watch?v=jWeLajon9M8) and [how to get started](https://www.youtube.com/watch?v=q3WRi47Grgs)|	LUIS|Beginner
| | Integrate LUIS into bots |This [tutorial](https://docs.microsoft.com/en-us/azure/cognitive-services/LUIS/luis-nodejs-tutorial-build-bot-framework-sample) about integrating LUIS and bots | LUIS, Bot Framework | Beginner
...
| | Voice design best practies |This Cortana web page about [voice design best practices](https://docs.microsoft.com/en-us/cortana/design-guides/voice-design-best-practices) | Cortana, LUIS, Bot Framework | Intermediate
