...
| Understand storage methods for the Personalized Offers Solution| Azure Storage Que | This web page about [storage queues](https://azure.microsoft.com/en-us/services/storage/queues/) | Storage Queues | Overview | None | 
...
| Understand the data ingestion methods for the Personalized Offers Solution | Azure Event Hubs | This web page [about Azure event hubs](https://azure.microsoft.com/en-us/services/event-hubs/) | Azure Event Hubs | Overview | None | 
...
| Understand how experiments are created with real-time streaming | Azure ML | This video [about Azure ML](https://channel9.msdn.com/Blogs/Azure/Azure-Machine-Learning) | Azure ML | Overview | None | 
...
| Understand how tasks are processed and completed for the Personalized Offers Solution | Azure Functions | This web page [about Azure Functions and resources](https://github.com/Azure/Azure-Functions) | Azure Functions | Overview | None | 
